...
sub new {
  ...
  my $self = {
    ...
    Wrong_passwd => "Вы дали непверный пароль для этих страниц.",
    ...
    DonationSentence => "Программное обеспечение генеалогического дерева абсолютно свободно. Однако, чтобы держать его в живых добавления необходимы.",
    Go => "Перейти",
    Unknown => "Неизвестный",
    name => "Имя",
    photo => "Фотография",
